...
public class Step_14_Parallel_Genetic_Programming_Search {
    ...
    public static void main(String[] args) {
        System.out.println();
        System.out.println(">>> Tutorial step 14 (Parallel Genetic Programming) example started.");
        ...
        try (Ignite ignite = Ignition.start("examples-ml/config/example-ignite.xml")) {
            try {
                ...
                System.out.println(">>> Tutorial step 14 (Parallel Genetic Programming) example completed.");
            }
