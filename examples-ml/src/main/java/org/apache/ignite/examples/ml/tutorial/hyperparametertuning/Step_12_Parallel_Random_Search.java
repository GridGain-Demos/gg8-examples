...
public class Step_12_Parallel_Random_Search {
    ...
    public static void main(String[] args) {
        System.out.println();
        System.out.println(">>> Tutorial step 12 (Parallel Random Search) example started.");
        ...
        try (Ignite ignite = Ignition.start("examples-ml/config/example-ignite.xml")) {
            try {
                ...
                System.out.println(">>> Tutorial step 12 (Parallel Random Search) example completed.");
            }
